...
class AIService:
    ...
    def generate_outreach_message(self, customer: Customer) -> str:
        ...
        - DO NOT use any exclamation marks (!). They make the voice engine sound unnatural. Use ellipses (...) or periods (.) instead.
        ...
        - Add frequent commas (,) and ellipses (...) to force the voice engine to take natural pauses and speak slowly. This prevents the voice from sounding rushed.
